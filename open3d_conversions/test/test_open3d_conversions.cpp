...
TEST(ConversionFunctionsTgeometry, open3dToRos_uncolored_tgeometry)
{
  ...
  for (int i = 0; i < 5; ++i)
  {
    open3d::core::Tensor o3d_tpc_points = open3d::core::eigen_converter::EigenVector3dToTensor(
      Eigen::Vector3d(0.5 * i, i * i, 10.5 * i), dtype_f, device_type);
...
TEST(ConversionFunctionsTgeometry, open3dToRos_colored_tgeometry)
{
  ...
  for (int i = 0; i < 5; ++i)
  {
    ...
    open3d::core::Tensor o3d_tpc_colors = open3d::core::eigen_converter::EigenVector3dToTensor(
      Eigen::Vector3d(2 * i / 255.0, 5 * i / 255.0, 10 * i / 255.0), dtype_f, device_type);
    o3d_TensorList_points.PushBack(o3d_tpc_points);
...
TEST(ConversionFunctionsTgeometry, rosToOpen3d_colored_tgeometry)
{
  ...
  open3d_conversions::rosToOpen3d(ros_pc2_ptr, o3d_tpc);
  open3d::core::TensorList o3d_TensorList_points = o3d_tpc.GetPoints();
  open3d::core::TensorList o3d_TensorList_colors = o3d_tpc.GetPointColors();
