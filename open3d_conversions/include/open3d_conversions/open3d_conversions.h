...
/**
*@brief Copy data from a open3d::tgeometry::PointCloud to a sensor_msgs::PointCloud2
*
 ...
 * @param skip_colors If true, only xyz fields will be copied
 */
void rosToOpen3d(const sensor_msgs::PointCloud2ConstPtr& ros_pc2, open3d::tgeometry::PointCloud& o3d_pc,
                 bool skip_colors = false);
}    // namespace open3d_conversions
